...
if [ "$1" == "--clean" ]; then
  rm -f favicon.ico icon-512.png icon-192.png apple-touch-icon.png
  exit 0
fi
...
rm tmp.png
inkscape "$1" -w 512 -h 512 -o icon-512.png
inkscape "$1" -w 192 -h 192 -o icon-192.png
inkscape "$1" -w 180 -h 180 -o apple-touch-icon.png
oxipng -o 4 icon-512.png icon-192.png apple-touch-icon.png # compress
